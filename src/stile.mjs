...
/* Dauerhafte Lernfamilien-Farben. Anders als die alte Gebietspalette trennen
...
const FACH_LERNFARBE = Object.freeze({
  bgbat: "bgbat",
  schuld: "schuld", schuldbt: "schuld", delikt: "schuld", bereich: "schuld", gesetzs: "schuld",
  sachen: "sachen",
  arbeit: "nebenfach", famerb: "nebenfach", handelsg: "nebenfach", ipr: "nebenfach",
  zpo: "zpo", zwangsv: "zpo", assessorz: "zpo",
  strafat: "strafat",
  strafbt: "strafbt", stpo: "strafbt", anklage: "strafbt", revision: "strafbt",
  staat: "oeffentlich", grundr: "oeffentlich", verwalt: "oeffentlich", verwbt: "oeffentlich", vwgo: "oeffentlich", europa: "oeffentlich", assessoroer: "oeffentlich",
  methodik: "methodik", mindset: "methodik",
  wochenrueckblick: "woche",
});

export function lernPalette(fach, fallback = null) {
  return LERNFARBEN[FACH_LERNFARBE[String(fach || "").toLowerCase()]] || fallback;
}
/* ==========================================================================
...
export const STILE = {
  ...
  bunt: {
    ...
    tagFarben: {
      ...
      /* Wochenrückblick: eigene goldene Kategorie, damit der Sonntag im Raster
         sofort als Zusammenfassung erkennbar ist. */
...
export const ICONS = {
  ...
  /* Das Paragrafenzeichen wird gesetzt, nicht gezeichnet. Die nachgezeichnete
     Variante sah aus wie zwei ineinandergehakte S - jeder Jurist erkennt den
     Unterschied sofort, und ein Zeichen, das es in jeder Schrift gibt, muss
     man nicht nachbauen. Die Schrift kommt von der Kachel (currentColor,
     Titelschrift), fill statt stroke - sonst bliebe die Kontur leer. */
