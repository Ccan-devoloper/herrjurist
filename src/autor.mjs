...
- marken: ein bis zwei sehr kurze Stichwortzeilen je Szene, die den Kern der Szene tragen. 2 bis 6 Wörter, KEIN ganzer Satz, kein Punkt am Ende. Sie stehen groß auf der Bühne, während die Stimme erklärt – sie wiederholen den Sprechertext also nicht, sie verdichten ihn. Genau EIN Wort je Zeile setzt du in *Sternchen*; das wird farbig hervorgehoben, und es muss das Wort sein, auf das es ankommt. Beispiele: „Schuldner *bietet an*“, „§ 294 BGB: *tatsächliches* Angebot“, „Frist *entbehrlich*“. Bei der cta-Szene genügt eine Zeile.
- bildSzene je Szene: eine ENGLISCHE Beschreibung einer konkreten Alltagsszene mit EINER Person oder EINEM Gegenstand, 3 bis 6 Wörter, nach denselben Regeln wie das Cover-Motiv unten. Sie wird als freigestellte Figur groß neben den Text gestellt.
  Entscheidend: Sie muss genau das zeigen, was DIESE Szene sagt – nicht das Thema allgemein. Prüfe jede Beschreibung mit der Gegenfrage „Würde jemand, der nur dieses Bild sieht und den gesprochenen Satz hört, beides zusammenbringen?“ Für „Der Gläubiger nimmt nicht an“ also „person with folded arms turning away“, für „Der Schuldner bietet an“ „delivery man holding out a parcel“ – zwei verschiedene Bilder, weil zwei verschiedene Aussagen. Gib NICHT in allen Szenen dieselbe oder eine fast gleiche Beschreibung an; jede Szene bekommt ihr eigenes Bild.
