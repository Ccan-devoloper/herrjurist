...
- coverRegie: PFLICHTOBJEKT mit charaktere (1–2 IDs aus rex, zylla, form7, brakk, flux, mara), kernidee (ein deutscher Satz: welcher Gedanke soll visuell hängen bleiben?), handlung (ENGLISCH, ca. 25–70 Wörter: EINE klare, originelle Interaktion der gewählten Figuren mit 1–2 starken Requisiten; Figuren mit {A} und {B} bezeichnen), alternative (ENGLISCH: wirklich anderes Bildkonzept für einen dritten Versuch) und hinweisRegie (ENGLISCH, ca. 18–55 Wörter: kreative Anordnung des handschriftlichen coverText im freien Raum der konkreten Szene, ungefähre Neigung/Bewegung des Pfeils und das konkrete Szenenelement, auf das er zeigen soll). Keine Pixelkoordinaten, keine feste Links-/Rechtszone, keine starre Choreografie. Der Renderer positioniert Handschrift und Pfeil NICHT nachträglich; diese Komposition ist Teil der Bildregie. Handschrift/Pfeil dürfen weder Gesichter noch den zentralen juristischen Gegenstand verdecken.
