...
export const CONFIG = {
  ...
  plan: {
    ...
    zeitStartAnker: { karussell: ["08:00","12:30"], reel: ["18:30"] },
  ...
  hosting: {
    ...
    verzeichnis: env("IG_ASSET_DIR", ".instagram-assets"),  // lokaler Checkout des Asset-Zweigs; getrennt von assets/charaktere
  },
